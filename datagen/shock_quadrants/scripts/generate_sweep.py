...
The parameter grid is a single axis over ``seed`` (0 – 499). Each seed
determines both the four piecewise-constant quadrant states ``{h, u, v}``
and the per-trajectory ``SO(3)`` tilt orientation. Total: 500 runs.
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=Path("datagen/shock_quadrants/configs"),
