...
resolve)::
    ...
    uv run --project datagen python -m datagen.mitgcm.scripts.preflight generate \\
        --out datagen/mitgcm/configs/preflight/

    uv run --project datagen python -m datagen.mitgcm.scripts.preflight run \\
        --config datagen/mitgcm/configs/preflight/corner_00.json \\
...
from datagen.mitgcm.scripts.generate_sweep import FIXED_PARAMS, PARAM_GRID
from datagen.mitgcm.solver import RunConfig, run_simulation
...
def _parse_args() -> argparse.Namespace:
    ...
    ap_gen.add_argument(
        "--out", type=Path,
        default=Path("datagen/mitgcm/configs/preflight"),
